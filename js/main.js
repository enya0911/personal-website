...
function initScrollAnimations() {
    ...
    // 觀察需要動畫的元素
    const animatedElements = document.querySelectorAll('.professional-card, .service-item, .about-content, .contact-content, .column-item, .venture-item, .gallery-item, .mass-intro, .mass-story, .mass-mission, .mass-cta, .leadership-card, .pepper-salt-concept, .leadership-quote');
